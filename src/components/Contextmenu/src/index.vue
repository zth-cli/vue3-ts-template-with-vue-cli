<template>
  <slot></slot>
  <Teleport to="body"><div class="zth-context-mask" v-show="showContext" ref="mask"></div></Teleport>
  <div class="zth-context" :style="{ left: left + 'px', top: top + 'px' }" v-show="showContext" ref="contextDom">
    <slot name="menu"> </slot>
  </div>
</template>
